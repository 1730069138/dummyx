"""
VLSA / AEGIS V2.5 reproduction for the user's MuJoCo screwdriver pick-and-place scene.
...
def main(args):
    ...
    print("\n" + "=" * 90)
    print("VLSA/AEGIS V2.5 — perception geometry diagnostics + full-action CBF-QP")
    print(
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=(
            "VLSA/AEGIS V2.5: perception diagnostics + MVEE + full-action CBF-QP + pickup-gate diagnosis "
